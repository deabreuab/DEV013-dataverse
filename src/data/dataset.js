export default [
  {
    ...
    gender: "Femenino",
    shortDescription:
      "Perro deportista y enérgico, amante del ejercicio y las competiciones.",
    description:
    ...
    imageUrl:
      "https://dodo.ac/np/images/thumb/c/c2/Bea_NH.png/150px-Bea_NH.png",
    facts: {
      zodiacSign: "Leo",
  ...
  },
  {
    ...
    gender: "Femenino",
    shortDescription:
      "Tigre deportista y competitivo, siempre en busca de desafíos atléticos.",
    description:
      "Claudia es una tigre deportista con una actitud competitiva y enérgica en Animal Crossing. Siempre está lista para un desafío y se enorgullece de mantenerse en forma y activa. Claudia es apasionada por los deportes y disfruta de la compañía de otros habitantes que comparten su entusiasmo por el ejercicio. Aunque ella puede ser competitiva, también es amigable y leal con sus amigos. Su catchphrase es '¡A rugir!', reflejando su espíritu competitivo. Claudia celebra su cumpleaños el 22 de noviembre.",
    imageUrl:
      "https://dodo.ac/np/images/thumb/d/d6/Claudia_NH.png/320px-Claudia_NH.png",
    facts: {
  ...
  },
  {
    ...
    gender: "Masculino",
    shortDescription:
      "Tigre gruñón y fuerte, siempre busca ser el más fuerte del pueblo.",
    description:
    ...
    imageUrl:
      "https://dodo.ac/np/images/thumb/9/93/Rolf_NH.png/150px-Rolf_NH.png",
    facts: {
      zodiacSign: "Leo",
      catchPhrase: "¡Grrrr!",
